...
import nayapuranaa.model.Customer;
...
public class CustomerController {
	...
	public ModelAndView add(HttpServletRequest request, ModelMap model) {
		...
		c.setAddress(HtmlUtils.htmlEscape(request.getParameter("address")));
		c.setLandmark(HtmlUtils.htmlEscape(request.getParameter("landmark")));
		c.setCity(HtmlUtils.htmlEscape(request.getParameter("city")));
		c.setPincode(HtmlUtils.htmlEscape(request.getParameter("pincode")));
		c.setName(name);
		c.setEmail(email);
		c.setDate(new Date());
