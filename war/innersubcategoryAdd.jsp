...
<title>Add InnerSubCategory | NaayaPuranaa</title>
</head>
<body>
	Category :
	...
	<form method="post" action="add">
		<table>
			<tr>
				...
				<td><select style="width: 185px;" name="subcategory" id="subcategory" >
					<%
