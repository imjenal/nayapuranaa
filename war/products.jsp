...
<jsp:include page="header.jsp" />
 <div class="main">
    <div class="content">
		...
		String catname=(String)request.getAttribute("name");
%>
 	<div class="content_top">
    		<div class="back-links">
    		<p><a href="index">Home</a> >> <a href="products?name=<%=catname%>"><%=catname %></a></p>
    	    </div>
    	<!-- 	<div class="sort">
    		<p>Sort by:
    			<select>
...
<%
    	...
    	try {
    		subcats = (List<SubCategory>) q.execute(catname);
    	} catch(Exception e){
    	}
    	...
    	q1.setFilter("subCategory==subcatParam");
    	...
    	<div class="content_top">
    		...
    		<h3 style="float:left;"><a href="subproducts?name=<%=sub.getName()%>" ><%=sub.getName() %></a></h3>
    		<h4 style="float:right;"><a href="subproducts?name=<%=sub.getName()%>" >View All</a></h4>
    		</div>
    	<!-- 	<div class="sort">
    		<p>Sort by:
