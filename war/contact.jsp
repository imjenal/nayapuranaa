...
<html>
<head>
<title>Nuevo Shop a Ecommerce Online Shopping Flat Bootstarp Resposive Website Template | Contact :: w3layouts</title>
					...
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								<h4>Clothing</h4>
								<ul>
									<li><a href="product.jsp">new arrivals</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								<h4>kids</h4>
								<ul>
									<li><a href="product.jsp">Pools &amp; Tees</a></li>
									<li><a href="product.jsp">shirts</a></li>
									<li><a href="product.jsp">shorts</a></li>
									<li><a href="product.jsp">twinsets</a></li>
									<li><a href="product.jsp">kurts</a></li>
									<li><a href="product.jsp">jackets</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col1">
							<div class="h_nav">
								<h4>Bags</h4>
								<ul>
									<li><a href="product.jsp">Handbag</a></li>
									<li><a href="product.jsp">Slingbags</a></li>
									<li><a href="product.jsp">Clutches</a></li>
									<li><a href="product.jsp">Totes</a></li>
									<li><a href="product.jsp">Wallets</a></li>
									<li><a href="product.jsp">Laptopbags</a></li>
								</ul>	
							</div>												
						</div>
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="account.jsp">create an account</a></li>
									<li><a href="product.jsp">create wishlist</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								<h4>Accessories</h4>
								<ul>
									<li><a href="product.jsp">Belts</a></li>
									<li><a href="product.jsp">Pens</a></li>
									<li><a href="product.jsp">Eyeglasses</a></li>
									<li><a href="product.jsp">accessories</a></li>
